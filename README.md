...
<body>
    <div class="jumbotron jumbotron-fluid" style="background-color: rgb(47, 143, 223);">
    ...
    <div class="container">
        <form action="/HouseModelPrediction/" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="text" readonly class="form-control" id="area" name="area" placeholder="1500" value="{{area}}">
                </div>
            </div>
             <div class="form-group row">
                <label for="bathrooms" class="col-md-2 col-form-label">Bath Rooms</label>
                <div class="col-md-10">
                    <input type="text" readonly class="form-control" id="bathrooms" name="bathrooms" placeholder="2" value="{{bathrooms}}">
                </div>
            </div>
            <div class="form-group row">
                <label for="bhk" class="col-md-2 col-form-label">Bedroom Hall Kitchen</label>
                <div class="col-md-10">
                    <input type="text" readonly class="form-control" id="bhk" name="bhk" placeholder="3" value="{{bhk}}">
                </div>
            </div>
            <div class="form-group row">
